...
@onready var gold_label: Label = $MarginContainer/HBoxContainer/StatsContainer/GoldLabel
@onready var void_label: Label = $MarginContainer/HBoxContainer/StatsContainer/VoidLabel
@onready var stability_label: Label = $MarginContainer/HBoxContainer/StatsContainer/StabilityLabel
@onready var balls_label: Label = $MarginContainer/HBoxContainer/StatsContainer/BallsLabel
